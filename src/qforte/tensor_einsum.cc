    ...
    std::complex<double> beta)
{
    ...
    // need an initialized_ variable for tensor...
...
//                 double* Atp = Ap + Aind0 * Astrides[0];
...
//     return C;
// }
// std::shared_ptr<Tensor> Tensor::einsum(
//     const std::vector<std::string>& Ainds,
