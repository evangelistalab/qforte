...
def rtl_energy(mol, ref, dt, nstates, print_mats=True, return_all_eigs=False, return_S=False, return_Hbar=False):
    ...
    # for p in range(nstates):
    #     h_mat[p][p] = rtl_helpers.matrix_element(ref, dt, p, p, mol.get_hamiltonian(),
    #                                     nqubits, mol.get_hamiltonian())
    #     s_mat[p][p] = rtl_helpers.matrix_element(ref, dt, p, p, mol.get_hamiltonian(),
    #                                     nqubits)
...
def mr_rtl_energy(mol, ref_lst, C_ref_lst, nstates_per_ref=1, print_mats=True, return_all_eigs=False, return_S=False, return_Hbar=False):
    ...
    #first do specific case of using differnet refs
    # for I in range(num_refs):
    #     for J in range(I, num_refs):
    #         for m in range(nstates_per_ref):
    #             for n in range(m, nstates_per_ref):
    #
