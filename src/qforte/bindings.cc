...
PYBIND11_MODULE(qforte, m) {
    ...
    m.def("is_even", &is_even, "A function that checks if a number is even");
}
...
//                                              static_cast<double_c*>(buf_info.ptr) +
//                                              buf_info.size);
...
//             }
//             // std::string msg = fmt::format("make_gate()\ttarget = {}, parameter = {} is not a
//             // valid "
...
//                 }
//             }
//             // std::string msg = fmt::format("make_gate()\ttarget = {}, control = {}, is not a
//             valid
//             // "
//             //                               "quantum gate input for type = {}",
//             //                               target, control, type);
...
//             return computer;
//         },
//         "nqubit"_a, "gates"_a, "A convenience function to prepare a state from a list of
//         gates.");
...
//             return computer;
//         },
//         "nqubits"_a, "gates"_a, "A convenience function to prepare a state from a list of
//         gates.");
...
//                :param orb_irrep_to_int: List of integers where the i-th element is the irrep of
//                spatial orbital i. :param spinorb_indices: List of spinorbital indices. :return:
//                Integer representing the irrep (in Cotton ordering) of the given set of
//                spinorbitals.
//            )pbdoc",
