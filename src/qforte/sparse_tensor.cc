...
std::map<size_t, std::complex<double>>::const_iterator SparseVector::get_element_it(size_t I) const {
    std::map<size_t, std::complex<double>>::const_iterator i = values_.find(I);
    return i;
}
...
void SparseVector::set_element(size_t I, std::complex<double> val) {
    values_[I] = val;
}

std::map<size_t, std::complex<double>> SparseVector::to_map() const {
    return values_;
}

void SparseVector::erase(size_t I) {
    values_.erase(I);
}
...
std::map<size_t, SparseVector> SparseMatrix::to_vec_map() const {
    return values_;
}
